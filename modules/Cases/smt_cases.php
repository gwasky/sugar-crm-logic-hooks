...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class smt_cases{
		...
		function smt_cases(&$bean, $event, $arguments){
		
		function sendHTMLemail14($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->rel_fields_before_value['qs_queues_cases_name'] != 'SMT Cases Pending' && $bean->qs_queues_cases_name == 'SMT Cases Pending')
			{

				$subject = "Notification Type: Case Logged to SMT";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Case Logged to SMT</span></td>
  </tr>
  <tr>
    <td width='30%' align='left' valign='top'><span class='style6'>Dear SMT,</span></td>
    <td width='70%' align='left' valign='top'><span class='style7'></span></td>
  </tr>
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Case for account '{$bean->account_name}' with subject '{$bean->name}' has been assigned to SMT Cases Pending Queue</span></td>
  </tr>
  <tr>
...
";
			  $to = 'complaintsupport@waridtel.co.ug,grace.kigundu@waridtel.co.ug,ccbusinessanalysis@waridtel.co.ug';
...
//$to = 'daniel.katatumba@waridtel.co.ug';
				...
				sendHTMLemail14($to,$body,$subject,$from);
