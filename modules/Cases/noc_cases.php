...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class noc_cases{
		...
		function noc_cases(&$bean, $event, $arguments){
		function sendHTMLemail18($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->rel_fields_before_value['qs_queues_cases_name'] != 'NOC Cases Pending' && $bean->qs_queues_cases_name == 'NOC Cases Pending')
			
			{

				$subject = "Notification Type: Case Logged to NOC";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Case Logged to NOC</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Case for account '{$bean->account_name}' with subject '{$bean->name}' has been assigned to NOC Cases Pending Queue</span></td>
  </tr>
  <tr>
    <td align='left' valign='top'><span class='style3'>Pending Tasks:</span></td>
    <td align='left' valign='top'><span class='style6'>1. Review case details, call SMT for further details to ease troubleshoot process (Troubleticket: {$bean->subject_setting_c}).<br /> 
...
";
		$to = 'PACKETCORENETWORKS@waridtel.co.ug,noc@waridtel.co.ug,grace.kigundu@waridtel.co.ug,ccbusinessanalysis@waridtel.co.ug';
...
//$to = 'daniel.katatumba@waridtel.co.ug';
				...
				sendHTMLemail18($to,$body,$subject,$from);
