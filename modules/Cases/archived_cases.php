...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class archived_cases{
 
		function archived_cases(&$bean, $event, $arguments){
		function sendHTMLemail20($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->rel_fields_before_value['qs_queues_cases_name'] !== 'Cases Archive' && $bean->qs_queues_cases_name === 'Cases Archive')
			
			{

				$subject = "Notification Type: Case Closed and Archived";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Case Closed and Archived</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Case for account '{$bean->account_name}' with subject '{$bean->name}' has been Closed and Archived. Well Done Customer Care and NOC Support Teams.
</span></td>
  </tr>
  <tr>
    <td align='left' valign='top'><span class='style3'>Pending Tasks:</span></td>
    <td align='left' valign='top'><span class='style6'>None</span></td>
  </tr>
    <tr>
...
";
		  $to = 'CCCONTACTCENTREMANAGEMENTTEAM@waridtel.co.ug,noc@waridtel.co.ug,complaintsupport@waridtel.co.ug,PACKETCORENETWORKS@waridtel.co.ug,grace.kigundu@waridtel.co.ug,ccbusinessanalysis@waridtel.co.ug';
...
//$to = 'daniel.katatumba@waridtel.co.ug';
				...
				sendHTMLemail20($to,$body,$subject,$from);
