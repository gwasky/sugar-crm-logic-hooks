...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->rel_fields_before_value['qs_queues_cases_name'] != 'Packet Core Cases Pending' && $bean->qs_queues_cases_name == 'Packet Core Cases Pending')
			{
...
";
			 $to = 'PACKETCORENETWORKS@waridtel.co.ug,ccbusinessanalysis@waridtel.co.ug,henry.butele@waridtel.co.ug,milton.mubangizi@waridtel.co.ug,gibson.wasukira@waridtel.co.ug,martin.musasizi@waridtel.co.ug';
