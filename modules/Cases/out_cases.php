...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class out_cases{
		...
		function out_cases(&$bean, $event, $arguments){
		function sendHTMLemail19($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->rel_fields_before_value['qs_queues_cases_name'] != 'CC Cases Outbound' && $bean->qs_queues_cases_name == 'CC Cases Outbound')
			{

				$subject = "Notification Type: CC Cases Outbound";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> CC Cases Outbound</span></td>
  </tr>
  <tr>
    <td width='30%' align='left' valign='top'><span class='style6'>Dear CC,</span></td>
    <td width='70%' align='left' valign='top'><span class='style7'></span></td>
  </tr>
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Case for account '{$bean->account_name}' with subject '{$bean->name}' has been assigned to CC Cases Outbound Queue</span></td>
  </tr>
  <tr>
    <td align='left' valign='top'><span class='style3'>Pending Tasks:</span></td>
    <td align='left' valign='top'><span class='style6'>1. Call Customer to confirm that case has been resolved.<br /> 
    2. Change case status to closed and assign to Cases Archive Queue.</span></td>
  </tr>
      <tr>
...
";
		$to = 'CCCONTACTCENTREMANAGEMENTTEAM@waridtel.co.ug,grace.kigundu@waridtel.co.ug,ccbusinessanalysis@waridtel.co.ug,CCSUPPORTCENTRE@waridtel.co.ug';
				...
				sendHTMLemail19($to,$body,$subject,$from);
