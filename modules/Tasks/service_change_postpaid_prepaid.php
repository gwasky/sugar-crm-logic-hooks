...
class service_type_change_postpaid_prepaid{
	
	function service_type_change_postpaid_prepaid(&$bean, $event, $arguments){
		if($event == 'before_save' && $_POST['task_type_c'] == 'Change in Service Type [Postpaid to Prepaid]'){
			$subject = "Change in Service Type [Postpaid to Prepaid]";
			$body .= "
...
";
		   $to = 'CCBUSINESSANALYSIS@waridtel.co.ug,creditcollection@waridtel.co.ug,corporatesales@waridtel.co.ug,ian.wamara@waridtel.co.ug,grace.kigundu@waridtel.co.ug,joseph.nsamba@waridtel.co.ug,peter.angole@waridtel.co.ug,RA@waridtel.co.ug';
