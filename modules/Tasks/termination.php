...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class termination{
		...
		function termination(&$bean, $event, $arguments){
		
		function sendHTMLemail21($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->fetched_row['Termination Of Service'] !== 'Termination Of Service' && $bean->task_type_c === 'Termination Of Service')
			
			{

				$subject = "Notification Type: Termination Of Service";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Termination Of Service</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>The Account {$bean->parent_name} has made Termination Of Service request</span></td>
  </tr>
  <tr>
    <td align='left' valign='top'><span class='style3'>Pending Tasks:</span></td>
    <td align='left' valign='top'><span class='style6'>1. Vet Account.<br /> 
    2. Assign Account to NOC Deactivation Queue</span></td>
  </tr>
  <tr>
...
//$to = 'CCBUSINESSANALYSIS@waridtel.co.ug';
				...
				sendHTMLemail21($to,$body,$subject,$from);
