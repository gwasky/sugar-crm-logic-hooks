...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class account_name_change{
 
		function account_name_change(&$bean, $event, $arguments){
		
		function sendHTMLemail7878($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->fetched_row['task_type_c'] !== 'Change In Account Name' && $bean->task_type_c === 'Change In Account Name')
			
			{

				$subject = "Notification Type: Change In Account Name";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Change In Account Name</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>The Account {{$bean->parent_name} has made a Change In Account Name request</span></td>
  </tr>
  <tr>
    <td align='left' valign='top'><span class='style3'>Pending Tasks:</span></td>
    <td align='left' valign='top'><span class='style6'>1. Change Account Name Only.<br /> 
    2. Save New Account Details</span></td>
  </tr>
  <tr>
...
//$to = 'CCBUSINESSANALYSIS@waridtel.co.ug';
				...
				sendHTMLemail7878($to,$body,$subject,$from);
