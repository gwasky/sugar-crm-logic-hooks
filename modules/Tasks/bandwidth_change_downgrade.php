...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class bandwidth_change_downgrade{
 
		function bandwidth_change_downgrade(&$bean, $event, $arguments){
		
		function sendHTMLemail35($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->fetched_row['task_type_c'] !== 'Change Of Bandwidth (Downgrade)' && $bean->task_type_c === 'Change Of Bandwidth (Downgrade)')
			
			{

				$subject = "Change Of Bandwidth (Downgrade)";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Change Of Bandwidth (Downgrade)</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>The Account {$bean->parent_name} has made a Bandwidth Profile Downgrade request.</span></td>
  </tr>
  <tr>
    <td align='left' valign='top'><span class='style3'>Pending Tasks:</span></td>
    <td align='left' valign='top'><span class='style6'>1. Vet Account. Please set the commence date of the downgrade in the form to the begining of the new month. This will allow the system to notify NOC when to commence with downgrade<br /> 
    2. You do not have to push the account to any queue</span></td>
  </tr>
  <tr>
