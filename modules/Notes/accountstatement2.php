...
<?php 
	    ...
	    require('../../billing/control.php');
	    $statement = accountStatement($_REQUEST['mem_id_c'], $_POST['start_date'], $_POST['end_date']);
...
<title>Wimax Statement for Account Number <? echo $_REQUEST['mem_id_c']; ?></title>
<style type="text/css">
<!--
...
<table width="100%" border="0" cellspacing="1">
  <tr>
    ...
    <input name="parent_id" type="hidden" value="<?php echo $_REQUEST['mem_id_c']; ?>" />
    </form></td>
  </tr>
  <tr>
    <td>
