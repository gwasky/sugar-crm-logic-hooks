...
if (!defined('sugarEntry') || !sugarEntry) die('Not A Valid Entry Point');
        ...
        class notify_noc{
				...
				function sendHTMLemail100($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
                        ...
                        if ($bean->fetched_row['trial_status_c'] != 'Assigned' && $bean->trial_status_c == 'Assigned')

                        {

                                $subject = "Notification Type: Troubleshoot Request";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Trial Troubleshoot</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Account '{$bean->accounts_tt_servicetrials_name}' is on trial troubleshoot.</span></td>
  </tr>
  <tr>
    <td align='left' valign='top'><span class='style3'>Pending Tasks:</span></td>
    <td align='left' valign='top'><span class='style6'>1. Configure troubleshoot bandwidth ({$bean->bandwidth}) in AAA<br>
    2. Change trial status from <strong>Assigned</strong> to <strong>Closed</strong></span></td>
  </tr>
  <tr>
...
";
		   $to = 'noc@waridtel.co.ug,PACKETCORENETWORKS@waridtel.co.ug,phiona.ireemera@waridtel.co.ug,CREDITCOLLECTION@waridtel.co.ug,ra@waridtel.co.ug,ccbusinessanalysis@waridtel.co.ug,revenuerecognition@waridtel.co.ug';
...
//$to = 'daniel.katatumba@waridtel.co.ug';
				...
				sendHTMLemail100($to,$body,$subject,$from);
