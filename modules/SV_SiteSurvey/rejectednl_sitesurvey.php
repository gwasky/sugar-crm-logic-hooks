...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class rejectednl_survey{
 
		function rejectednl_survey(&$bean, $event, $arguments){
		
		function sendHTMLemailNL($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->fetched_row['site_survey_status'] !== 'Rejected[Low/No Coverage]' && $bean->site_survey_status  == 'Rejected[Low/No Coverage]')
			
			{

				$subject = "Site Survey Rejected [Low/No Coverage]";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Site Survey Rejected[Low/No Coverage]</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>The Lead {$bean->leads_sv_sitesurvey_name} site survey status is marked as Rejected[Low/No Coverage]</span></td>
  </tr>
  <tr>
...
";
		   $to = 'daniel.katatumba@waridtel.co.ug,CORPORATESALES@waridtel.co.ug,joseph.nsamba@waridtel.co.ug,peter.angole@waridtel.co.ug,,richard.sserunjogi@waridtel.co.ug,Milton Mubangizi/Engineering/Kampala <milton.mubangizi@waridtel.co.ug>,ccbusinessanalysis@waridtel.co.ug';
...
//$to = 'daniel.katatumba@waridtel.co.ug';
				...
				sendHTMLemailNL($to,$body,$subject,$from);
