...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class approved_survey{
 
		function approved_survey(&$bean, $event, $arguments){
		
		function sendHTMLemailAP($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->fetched_row['site_survey_status'] !== 'Approved' && $bean->site_survey_status  == 'Approved')
			
			{

				$subject = "Site Survey Approved";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Site Survey Approved</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>The Lead {$bean->leads_sv_sitesurvey_name} site survey status is marked as approved</span></td>
  </tr>
  <tr>
    <td align='left' valign='top'><span class='style3'>Pending Tasks:</span></td>
    <td align='left' valign='top'><span class='style6'>1. Check CC Complete Site survey or wait Complete site survey notification for details.</span></td>
  </tr>
  <tr>
...
";
		   $to = 'CORPORATESALES@waridtel.co.ug,joseph.nsamba@waridtel.co.ug,peter.angole@waridtel.co.ug,richard.sserunjogi@waridtel.co.ug,Milton Mubangizi/Engineering/Kampala <milton.mubangizi@waridtel.co.ug>,ccbusinessanalysis@waridtel.co.ug';
...
//$to = 'daniel.katatumba@waridtel.co.ug';
				...
				sendHTMLemailAP($to,$body,$subject,$from);
