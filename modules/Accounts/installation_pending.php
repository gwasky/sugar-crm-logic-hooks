...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class installation_pending{
 
		function installation_pending(&$bean, $event, $arguments){
		
		function sendHTMLemail6($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->rel_fields_before_value['qs_queues_accounts_name'] !== 'Installation Pending' && $bean->qs_queues_accounts_name === 'Installation Pending')
			
			{

				$subject = "Notification Type: Installation Pending";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Installation Pending</span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align='left' valign='top'><span class='style6'>1. Complete Installation at customers premises<br /><span class='style3'>Requested Bandwidth:</span>{$bean->download_bandwidth_c},<br /> <span class='style3'>username:</span>{$bean->preferred_username_c},<br /> <span class='style3'>CPE Type:</span>{$bean->cpe_type_c}. <br />Update CRM<br /> 
...
//$to = 'daniel.katatumba@waridtel.co.ug';
				...
				sendHTMLemail6($to,$body,$subject,$from);
