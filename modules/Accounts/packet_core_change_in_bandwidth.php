...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class packet_core_change_in_bandwidth{
		...
		function packet_core_change_bandwidth(&$bean, $event, $arguments){
			...
			if ($bean->rel_fields_before_value['qs_queues_accounts_name'] !== 'Packet Core Change in Bandwidth' && $bean->qs_queues_accounts_name === 'Packet Core Change in Bandwidth')
			
			{
				...
				$subject = "Notification Type: Packet Core Change in Bandwidth";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Packet Core Change in Bandwidth</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Account {$bean->name} has been assigned to Packet Core Change in Bandwidth Queue.</span></td>
  </tr>
  <tr>
    <td align='left' valign='top'><span class='style3'>Pending Tasks:</span></td>
    <td align='left' valign='top'><p class='style6'>1. Change Bandwidth for the account (username: {$bean->preferred_username_c}). 
      </p>
    </td>
  </tr>
  <tr>
