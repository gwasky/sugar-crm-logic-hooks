...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class bandwidth_pending{
		
		function bandwidth_pending(&$bean, $event, $arguments){
		function sendHTMLemail8($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->rel_fields_before_value['qs_queues_accounts_name'] !== 'NOC Change In Bandwidth Pending' && $bean->qs_queues_accounts_name === 'NOC Change In Bandwidth Pending'){

				$subject = "Notification Type: NOC Change In Bandwidth Pending";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> NOC Change In Bandwidth Pending</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Account <a href='http://".$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF']."?action=DetailView&module=Accounts&record={$bean->id}'>{$bean->name}</a> has been assigned to NOC Change In Bandwidth Pending Queue.</span></td>
  </tr>
        <tr>
  ...
  <tr>
    ...
    <td align='left' valign='top'><span class='style6'>
		1. Modify customers service as follows : <strong>Bandwidth </strong> : {$bean->download_bandwidth_c}. <strong>No of Units</strong> : ".number_format($bean->bandwidth_count_1_c,2)." .<br />
    2. Assign to Bill Activation Pending Queue.</span></td>
  </tr>
  <tr>
    <td align='left' valign='top'><span class='style3'>Account Description Details:</span></td>
    <td align='left' valign='top'><span class='style6'><div class='style_desc'>".nl2br($bean->description)."</div></td>
  </tr>
  <tr>
...
";
$to = 'noc@waridtel.co.ug,PACKETCORENETWORKS@waridtel.co.ug,grace.kigundu@waridtel.co.ug,corporatesales@waridtel.co.ug,ccbusinessanalysis@waridtel.co.ug,CCCORPORATE@waridtel.co.ug';
//$to = 'steven.ntambi@waridtel.co.ug';
				...
				sendHTMLemail8($to,$body,$subject,$from);
