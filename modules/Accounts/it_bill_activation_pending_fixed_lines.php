...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class it_bill_activation_pending_fixed_lines{
		...
		// First we have to build our email headers
			...
			//echo "Sending mail <br>To : ".$to."<br>Subject : ".$subject."<br>Message : <br>".$HTML."<hr>";
			//exit();
		}
 
		function it_bill_activation_fixed_lines(&$bean, $event, $arguments){
			...
			if ($bean->rel_fields_before_value['qs_queues_accounts_name'] != 'IT Bill Activation Pending - Fixed Lines' && $bean->qs_queues_accounts_name == 'IT Bill Activation Pending - Fixed Lines'){
				//echo "Check passed : <br>Before : ".$bean->rel_fields_before_value['qs_queues_accounts_name']."<br>After : ".$bean->qs_queues_accounts_name."<hr>";
				...
				$subject = "Notification Type: IT Bill Activation Pending - Fixed Lines";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> IT Bill Activation Pending - Fixed Lines</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Account {$bean->name} has been assigned to IT Bill Activation Pending - Fixed Lines Queue.</span></td>
  </tr>
  ...
  <tr>
    ...
    <td align='left' valign='top'><span class='style6'>1. Enter Config information in Foris Billing System <br />
    2. Assign the account to Active Contracts Queue.</span></td>
  </tr>
  <tr>
...
";
				...
				echo "Check Failed : <br>Before : ".$bean->rel_fields_before_value['qs_queues_accounts_name']."<br>After : ".$bean->qs_queues_accounts_name."<hr>";
