...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class bill_pending{
		...
		function bill_pending(&$bean, $event, $arguments){
		function sendHTMLemail7($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->rel_fields_before_value['qs_queues_accounts_name'] !== 'Bill Activation Pending' && $bean->qs_queues_accounts_name === 'Bill Activation Pending')
			
			{

				$subject = "Notification Type: Bill Activation Pending";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Bill Activation Pending</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Account {$bean->name} has been assigned to Bill Activation Pending Queue.</span></td>
  </tr>
        <tr>
  ...
  <tr>
    ...
    <td align='left' valign='top'><span class='style6'>1. Create customers contract. Ensure that the start and end dates are set in relation to the amount paid. Set contract status to Active.<br /> 
    2. Assign to Active Contracts Queue.</span></td>
  </tr>
  <tr>
...
";
			 $to = 'creditcollection@waridtel.co.ug,grace.kigundu@waridtel.co.ug,corporatesales@waridtel.co.ug,ccbusinessanalysis@waridtel.co.ug,joseph.nsamba@waridtel.co.ug, peter.angole@waridtel.co.ug, paul.kagoda@waridtel.co.ug';
...
//$to = 'daniel.katatumba@waridtel.co.ug';
				...
				sendHTMLemail7($to,$body,$subject,$from);
