...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class deactivation_pending{
 
		function deactivation_pending(&$bean, $event, $arguments){
		
			function sendHTMLemail9($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->rel_fields_before_value['qs_queues_accounts_name'] !== 'NOC Deactivation Queue' && $bean->qs_queues_accounts_name === 'NOC Deactivation Queue')
			
			{

				$subject = "Notification Type: NOC Account Deactivation";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> NOC Account Deactivation</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Account {$bean->name} has been assigned to NOC Account Deactivation Queue.</span></td>
  </tr>
  <tr>
    <td align='left' valign='top'><span class='style3'>Pending Tasks:</span></td>
    <td align='left' valign='top'><span class='style6'>1. Deactivate the account (username: {$bean->preferred_username_c}).<br /> 
    2. Assign to C & C Deactivated Accounts Queue.</span></td>
  </tr>
  <tr>
...
//$to = 'daniel.katatumba@waridtel.co.ug';
				...
				sendHTMLemail9($to,$body,$subject,$from);
