...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class deactivation_done{
 
		function deactivation_done(&$bean, $event, $arguments){
		
			function sendHTMLemail_done($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->rel_fields_before_value['qs_queues_accounts_name'] !== 'NOC - C&C Deactivated accounts' && $bean->qs_queues_accounts_name == 'NOC - C&C Deactivated accounts')
			
			{

				$subject = "Notification Type: NOC - C&C Deactivated accounts";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> NOC - C&C Deactivated accounts</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Account {$bean->name} has been Deactivated.</span></td>
  </tr>
  <tr>
...
$to = 'creditcollection@waridtel.co.ug,ccbusinessanalysis@waridtel.co.ug,CCCORPORATE@waridtel.co.ug';
...
//$to = 'daniel.katatumba@waridtel.co.ug';
				...
				sendHTMLemail_done($to,$body,$subject,$from);
