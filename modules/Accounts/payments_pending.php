...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class payments_pending{
 
		function payments_pending(&$bean, $event, $arguments){
		
		function sendHTMLemailapp2($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->rel_fields_before_value['qs_queues_accounts_name'] !== 'Payments Pending' && $bean->qs_queues_accounts_name === 'Payments Pending')
			
			{

				$subject = "Notification Type: Payments Pending";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Payments Pending</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Account {$bean->name} has been assigned to Payments Pending Queue.</span></td>
  </tr>
        <tr>
  ...
  <tr>
    ...
    <td align='left' valign='top'><span class='style6'>1. Charge customers account accordingly. Recieve and enter payment details.<br /> 
    2. Assign account to NOC Configuration Pending Queue.</span></td>
  </tr>
  <tr>
...
//$to = 'daniel.katatumba@waridtel.co.ug';
				...
				sendHTMLemailapp2($to,$body,$subject,$from);
