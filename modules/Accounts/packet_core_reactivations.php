...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class packet_core_reactivations{
		...
		function packet_core_reactivation(&$bean, $event, $arguments){
			...
			if ($bean->rel_fields_before_value['qs_queues_accounts_name'] !== 'Packet Core Reactivations' && $bean->qs_queues_accounts_name === 'Packet Core Reactivations')
			
			{
				...
				$subject = "Notification Type: Packet Core Account Reactivation";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Packet Core  Account Reactivation</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Account {$bean->name} has been assigned to Packet Core Reactivations Queue.</span></td>
  </tr>
  <tr>
    <td align='left' valign='top'><span class='style3'>Pending Tasks:</span></td>
    <td align='left' valign='top'><p class='style6'>1. Reactivate the account (username: {$bean->preferred_username_c}). 
      </p>
    </td>
  </tr>
  <tr>
