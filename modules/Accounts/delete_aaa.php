...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
        ...
        class delete_aaa{
        	...
        	function delete_aaa(&$bean, $event, $arguments){
				function sendHTMLemail10($to,$HTML,$subject,$from){
				...
				if ($bean->rel_fields_before_value['qs_queues_accounts_name'] !== 'NOC Delete From AAA' && $bean->qs_queues_accounts_name === 'NOC Delete From AAA')

				{

                                $subject = "Notification Type: NOC Delete From AAA";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> NOC Delete From AAA</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Account {$bean->name} has been assigned to NOC Delete From AAA Queue.</span></td>
  </tr>
  <tr>
    <td align='left' valign='top'><span class='style3'>Pending Tasks:</span></td>
    <td align='left' valign='top'><span class='style6'>1. Delete the account from AAA (username: {$bean->preferred_username_c}).<br /> 
    2. Assign to C & C Deleted Accounts Queue.</span></td>
  </tr>
  <tr>
...
";
			  $to = 'complaintsupport@waridtel.co.ug,noc@waridtel.co.ug,creditcollection@waridtel.co.ug,grace.kigundu@waridtel.co.ug,corporatesales@waridtel.co.ug,ccbusinessanalysis@waridtel.co.ug,CCCORPORATE@waridtel.co.ug';
			...
			//$to = 'daniel.katatumba@waridtel.co.ug';
				...
				sendHTMLemail10($to,$body,$subject,$from);
			}
		}
	}
