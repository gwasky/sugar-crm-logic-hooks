...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class rf_planning{
		...
		function rf_planning(&$bean, $event, $arguments){
		
		function sendHTMLemail800($to,$HTML,$subject,$from){
...
// First we have to build our email headers
    ...
    mail($to,$subject,$HTML,$headers);
			...
			if ($bean->fetched_row['qs_queues_leads_name'] !== 'RF Planning' && $bean->qs_queues_leads_name === 'RF Planning')
			
			{

				$subject = "Notification Type: RF Planning";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> RF Planning</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Lead {$bean->first_name} - {$bean->last_name} has been assigned to RF Planning Queue. Contact Sales rep {$bean->sales_rep_c} for additional details.</span></td>
  </tr>
      <tr>
   ...
   <tr>
    <td align='left' valign='top'><span class='style3'>Reason:</span></td>
    <td align='left' valign='top'><span class='style6'>No Wimax Coverage in the Area, Failed Wimax Sitesurvey</span></td>
  </tr>
  <tr>
    <td align='left' valign='top'><span class='style3'>Pending Tasks:</span></td>
    <td align='left' valign='top'><span class='style6'>1. Contact Customer Care Field Ops team for more details.<br /> 
    2. After analysis, recomend platform and assign to relevant queue otherwise assign to Invalid Prospect Queue.</span></td>
  </tr>
  <tr>
...
//$to = 'daniel.katatumba@waridtel.co.ug';
				...
				sendHTMLemail800($to,$body,$subject,$from);
