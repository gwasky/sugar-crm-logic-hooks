...
//this acript is supposed to send an email when a lead has changed from one que to another, in this case new leads que
	...
	class valid_prospect{
 
		function valid_prospect(&$bean, $event, $arguments){
		
			$myquery = new uniquequerys();
			
			function sendHTMLemail3($to,$HTML,$subject,$from){
			...
			if ($bean->fetched_row['qs_queues_leads_name'] !== 'Valid Prospect' && $bean->qs_queues_leads_name === 'Valid Prospect')
			
			{
				...
				$subject = "Notification Type: Valid Prospect";
...
<body>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style3'>Notification Type:</span><span class='style6'> Valid Prospect</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><span class='style6'>Lead {$bean->first_name} - {$bean->last_name} has been assigned to Valid Prospect Queue. Contact Sales rep {$bean->sales_rep_c} for additional details.</span></td>
  </tr>
    <tr>
  ...
  <tr>
    ...
    <td align='left' valign='top'><span class='style6'>1. Revise Lead details<br /> 
    2. Convert Lead to Account.</span></td>
  </tr>
  <tr>
...
";
				...
				sendHTMLemail3($to,$body,$subject,$from);
