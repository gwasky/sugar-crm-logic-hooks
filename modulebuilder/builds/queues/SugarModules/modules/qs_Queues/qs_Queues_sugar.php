 ...
 * PLACE ANY CUSTOMIZATIONS IN qs_Queues
 */

require_once('include/SugarObjects/templates/company/Company.php');

class qs_Queues_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'qs_Queues';
	var $object_name = 'qs_Queues';
	var $table_name = 'qs_queues';
	var $importable = true;
